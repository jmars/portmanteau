...
var Contextify, Map, Portmanteau, Set, WeakMap, WebSocket, almondjs_source, domain, domino, express, fs, iced, path, requirejs_source, shoe, sockjs, url, _, __iced_k, __iced_k_noop, _ref,
  __slice = [].slice,
