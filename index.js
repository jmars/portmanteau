...
var Contextify, EventEmitter2, Map, Portmanteau, Set, WeakMap, almondjs_source, dnode, domino, express, fs, iced, path, requirejs_source, shoe, sockjs, url, wsclient, _, __iced_k, __iced_k_noop, _ref,
  __slice = [].slice,
...
Portmanteau = (function() {
  ...
  Portmanteau.prototype.createContext = function(req, res, next) {
    ...
    self = this;
    context.WebSocket = wsconnection = (function(_super) {

      __extends(wsconnection, _super);

      function wsconnection() {
        this.root = self;
        wsconnection.__super__.constructor.apply(this, arguments);
      }
  ...
  Portmanteau.prototype.RCE = null;
